    ...
    >
      ...
      >
        <Ionicons
          name={icon}
          size={20}
          color={color === colors.danger ? colors.danger : colors.primary}
        />
      </View>
      <Text
        style={[
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsRow}>
          {[
            {
              label: "Bookings",
              value: stats ? String(stats.bookings) : "—",
              icon: "calendar-outline" as const,
            },
            {
              label: "Reviews",
              value: stats ? String(stats.reviews) : "—",
              icon: "star-outline" as const,
            },
            {
              label: "Wallet",
              value: stats ? `₹${stats.wallet.toFixed(0)}` : "—",
        ...
        >
          ...
          <MenuSection title="Legal">
            ...
            <MenuItem
              ...
              label={`App Version ${Application.nativeApplicationVersion}`}
              onPress={() => {}}
            />
          </MenuSection>
